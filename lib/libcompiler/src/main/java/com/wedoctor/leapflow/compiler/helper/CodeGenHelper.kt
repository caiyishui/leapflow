...
object CodeGenHelper {
    ...
    private val TASK_INTERFACE = ClassName.get("com.wedoctor.leapflow.task", "ITask")
    private val FLOW_INTERFACE = ClassName.get("com.wedoctor.leapflow", "IFlow")
    ...
    private const val packageName = "com.wedoctor.leapflow"
